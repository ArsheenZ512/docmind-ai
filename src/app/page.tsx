...
export default function Home() {
  ...
  const removeDocument = (id: string) => {
    ...
    if (selectedDocument?.id === id) {
      setSelectedDocument(remainingDocuments[0] || null);
    }
  };
          ...
          {filteredDocuments.length > 0 ? (
            ...
            <div className="rounded-2xl border border-dashed border-white/10 p-6 text-center">
              ...
              <p className="mt-1 text-xs leading-5 text-slate-600">
                Upload a document to start building your knowledge
                base.
              </p>
            </div>
          )}
            ...
            {selectedDocument ? (
              <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-red-500/10 text-[10px] font-bold text-red-400">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Your documents will become searchable knowledge.
                </p>
              </div>
            )}
          </div>
            ...
            <div className="border-t border-white/10 p-4 sm:p-5">
              <div className="mx-auto max-w-4xl">
                ...
                <div className="mt-3 flex flex-col items-center justify-between gap-2 text-xs text-slate-600 sm:flex-row">
                  ...
                  <span>
                    DocMind AI may make mistakes. Verify important
                    information.
                  </span>
                </div>
              </div>
